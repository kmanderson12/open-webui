...
OPENSEARCH_SERVERLESS_REGION = os.environ.get("OPENSEARCH_SERVERLESS_REGION", "us-east-1")
OPENSEARCH_SERVERLESS_HOST = os.environ.get("OPENSEARCH_SERVERLESS_HOST", "")
OPENSEARCH_SERVERLESS_PORT = int(os.environ.get("OPENSEARCH_SERVERLESS_PORT", "443"))
OPENSEARCH_SERVERLESS_SERVICE_NAME = os.environ.get("OPENSEARCH_SERVERLESS_SERVICE_NAME", "aoss")
OPENSEARCH_SERVERLESS_INDEX_CREATION_DELAY = float(os.environ.get("OPENSEARCH_SERVERLESS_INDEX_CREATION_DELAY", "0"))
